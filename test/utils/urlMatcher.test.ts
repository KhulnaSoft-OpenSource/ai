...
test('getPullRequestAPIURL', async () => {
  expect(await getPullRequestAPIURL('https://github.com/khulnasoft-opensource/ai/pull/164')).toBe('https://api.github.com/repos/khulnasoft-opensource/ai/pulls/164')
  expect(await getPullRequestAPIURL('https://github.com/khulnasoft-opensource/ai/pull/163')).toBe('https://api.github.com/repos/khulnasoft-opensource/ai/pulls/163')
  expect(await getPullRequestAPIURL('https://github.com/khulnasoft-opensource/ai/compare/some-branch')).toBe('https://api.github.com/repos/khulnasoft-opensource/ai/compare/beta...some-branch')
  ...
  expect(await getPullRequestAPIURL('https://github.com/khulnasoft-opensource/ai/compare/beta...some-branch')).toBe('https://api.github.com/repos/khulnasoft-opensource/ai/compare/beta...some-branch')
