...
export const AICodeReviewMenu = (items: HTMLLIElement[]) => {
    ...
    <header class="SelectMenu-header">
       <div class="flex-1">
          ...
          <span class="color-fg-muted text-small pl-1">KhulnaSoft.ai</span>
       </div>
       <div class="Label Label--success">AI</div>
       <a class="ml-1 color-fg-muted d-block" target="_blank" href="https://github.com/orgs/khulnasoft-opensource/discussions">
       Give feedback
       </a>
    </header>
