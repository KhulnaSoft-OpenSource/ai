...
import { useOpensaucedUserCheck } from "../../hooks/useKhulnasoftUserCheck";
import { Profile } from "./profile";
import { goTo } from "react-chrome-extension-router";
import PostOnHighlight from "./posthighlight";
import { getRepoAPIURL } from "../../utils/urlMatchers";
import { getEmojis, getHighlights, getRepoKhulnaSoftURL } from "../../utils/fetchKhulnaSoftApiData";
...
const Home = ({ forceRefresh }: { forceRefresh: boolean } = { forceRefresh: false }) => {
    ...
    const [repoKhulnaSoftURL, setRepoKhulnaSoftURL] = useState<string>("");
